...
for learning_rate in learning_rateS:
    for num_epochs in epoch_list: 
        ...
        torch.save(model.state_dict(), 'cel_model_epoch{}_lr{}_bs{}.ckpt'.format(num_epochs,learning_rate,batch_size))
        ...
        with open('cel_model_epoch{}_lr{}_bs{}_info_results.txt'.format(num_epochs,learning_rate,batch_size), 'w') as output_file: 
            
            output_file.write('test_loss:       {}\n'.format(test_loss))
            output_file.write('accuracy:        {}\n'.format(accuracy))
            output_file.write('\n')
            output_file.write('hyperparameters:\n')
            output_file.write('sequence_length: {}\n'.format(sequence_length))
            output_file.write('input_dim:       {}\n'.format(input_dim))
            output_file.write('hidden_dim:      {}\n'.format(hidden_dim))
            output_file.write('num_layers:      {}\n'.format(num_layers))
            output_file.write('output_dim:      {}\n'.format(output_dim))
            output_file.write('batch_size:      {}\n'.format(batch_size))
            output_file.write('num_epochs:      {}\n'.format(num_epochs))
            output_file.write('learning_rate:   {}\n'.format(learning_rate))
            output_file.write('kernel_size:     {}\n'.format(kernel_size))
